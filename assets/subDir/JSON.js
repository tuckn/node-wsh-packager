...
if (typeof JSON !== 'object') {
  /**
   * json2.js {@link https://github.com/douglascrockford/JSON-js|GitHub}
   * @global
   * @namespace
   * @licence Public Domain.
  NO WARRANTY EXPRESSED OR IMPLIED. USE AT YOUR OWN RISK. USE YOUR OWN COPY. IT IS EXTREMELY UNWISE TO LOAD CODE FROM SERVERS YOU DO NOT CONTROL.
  2017-06-12
  This file creates a global JSON object containing two methods: stringify and parse. This file provides the ES5 JSON capability to ES3 systems. If a project might run on IE8 or earlier, then this file should be included. This file does nothing on ES5 systems.
  This is a reference implementation. You are free to copy, modify, or redistribute.
   */
  var JSON = {}; /* eslint no-redeclare: "off" */

  /** Define properties
      JSON, apply, call, charCodeAt, getUTCDate, getUTCFullYear, getUTCHours, getUTCMinutes, getUTCMonth, getUTCSeconds, hasOwnProperty, join, lastIndex, length, parse, prototype, push, replace, slice, stringify, test, toJSON, toString, valueOf */
  (function () {
    'use strict';
   ...
   If the type is "object", we might be dealing with an object or an array or null.
    ...
    if (typeof JSON.stringify !== 'function') {
       ...
       * @function stringify
       * @memberof JSON
       * @param {*} value - any JavaScript value, usually an object or array. JSON.stringify(undefined) returns undefined.
       * @param {(array|function)} [replacer] - an optional parameter that determines how object param values are stringified for objects. It can be a function or an array of strings.
